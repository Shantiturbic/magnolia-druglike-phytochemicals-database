...
SOURCE_REGISTRY: dict[str, SourceConfig] = {
    ...
    "npatlas": SourceConfig(
        ...
        unique_contribution="Curated microbial + plant NP atlas with DOI references",
        enabled=False,
        fallback="API broken as of 2026-05-21: basicSearch ignores query, returns first 10 of entire DB.",
    ),
    "npass": SourceConfig(
        name="npass",
        tier=1,
        ...
        unique_contribution="Species-activity-target triples for NPs",
        enabled=False,
        fallback="Site 404 as of 2026-05-21. Covered by LOTUS + ChEMBL.",
    ),
    "dr_duke": SourceConfig(
        ...
        enabled=False,
        fallback="Ag Data Commons ZIP returns HTML redirect as of 2026-05-21. Web search also 404.",
    ),
